    ...
    <section className="relative bg-gradient-to-br from-white via-secondary/5 to-primary/8 pt-24 pb-40 overflow-hidden">
      ...
      <div className="container relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-12 animate-in fade-in slide-in-from-bottom-4 duration-700">
          <div className="inline-block mb-6 px-4 py-2 rounded-full bg-gradient-to-r from-primary/15 to-accent/15 border border-primary/30 backdrop-blur-sm">
            <span className="text-sm font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent flex items-center gap-2">
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed max-w-2xl mx-auto">
            Discover thousands of opportunities from top companies. Search, apply, and get hired in minutes.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mt-16 max-w-2xl mx-auto">
          {[
            { number: "50K+", label: "Active Jobs", delay: 300 },
            { number: "10K+", label: "Companies", delay: 400 },
            { number: "100K+", label: "Hired Users", delay: 500 },
          ].map((stat, idx) => (
            <div
              key={idx}
